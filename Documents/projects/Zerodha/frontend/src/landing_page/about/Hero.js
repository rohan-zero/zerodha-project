...
function Hero() {
    return ( 
        <div className='container p-5'>
            <div className='row border-bottom p-5 mt-5 mb-5'>
                <h1 className='fs-1 text-center'>We pioneered the discount broking model in India.<br/>
                Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row border-bottom' style={{fontSize:"19px" , lineHeight:"1.8"}}>
